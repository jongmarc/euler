...
public class Problem008 {
    ...
    public static void main(String[] args) {
        ...
        long result = problem.largestProductInSerie(numbers, 13);
        long stop = System.nanoTime();
        long duration = stop - start;
        System.out.println("Problem 8 with my algorithm\n"+ result + " in " + duration + " nanoseconds.");
    }

    public long largestProductInSerie(String number, int numberOfNumbers) {
        if (number.length() < numberOfNumbers) 
            return - 1;
        ...
        for (int i = 0; i <= number.length() - numberOfNumbers; i++) {
            temp = 1;
